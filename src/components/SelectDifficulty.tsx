...
const SelectDifficulty: React.FC<SelectDifficultyProps> = ({
  ...
  return (
    <div className="grid grid-cols-3 gap-4 my-5">
      ...
      >
        <div
          className={`${difficulty === 'easy' ? 'bg-green-800' : 'bg-gray-800 group-hover:bg-gray-800/95'} min-w-[85px] rounded-[10px] p-3 flex flex-col items-center gap-2 `}
        >
      ...
      >
        <div
          className={`${difficulty === 'medium' ? 'bg-yellow-800' : 'bg-gray-800 group-hover:bg-gray-800/95'} min-w-[85px] rounded-[10px] p-3 flex flex-col items-center gap-2`}
        >
          {type === 'level' || type === 'size' ? (
      ...
      >
        <div
          className={`${difficulty === 'hard' ? 'bg-red-800' : 'bg-gray-800 group-hover:bg-gray-800/95'} min-w-[85px] rounded-[10px] p-3 flex flex-col items-center gap-2`}
        >
          {type === 'level' || type === 'size' ? (
